...
class FeatureExtractor:
    def __init__(self):
        ...
        try:
            ...
            print(f"[OK] MobileNetV4 loaded successfully on {self.device}.")
    ...
    def extract(self, img):
        ...
        img_tensor = img_tensor.unsqueeze(0).to(self.device)  # Add batch dimension and move to GPU
        
        # Extract features
        with torch.no_grad():
            features = self.model(img_tensor)
            
        # Convert to numpy and flatten (move back to CPU first)
